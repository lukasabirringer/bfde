<div class="notification-sticky js-cookie-consent cookie-consent" style="display: none;">
	<div class="content notification-sticky__content">
		...
		<button type="button" class="button notification-sticky__button js-cookie-consent-agree cookie-consent__agree">
			<span class="button__label ">{{ trans('cookieConsent::texts.agree') }}</span>
		</button>
	</div>
</div>
